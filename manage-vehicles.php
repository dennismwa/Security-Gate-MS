...
<body class="bg-gray-50">
        ...
        <?php elseif ($action == 'view' && isset($vehicle)): ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-8">
                <div class="lg:col-span-2 space-y-4 sm:space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6 space-y-2 sm:space-y-0">
                            ...
                            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 w-gray-600 hover:text-gray-900">
                ...
                <div class="flex items-center space-x-2 sm:space-x-4">
                    ...
                    <a href="dashboard.php" class="text-full sm:w-auto">
                                <a href="manage-vehicles.php?action=edit&id=<?php echo $vehicle['vehicle_id']; ?>" 
    ...
    <script>
        ...
        function quickVehicleAction(action) {
            ...
            formData.append('vehicle_qr', '<?php echo $vehicle['qr_code']; ?>');
            formData.append('action', action);
            formData.append('location_id', '1'); // Default location
            
            fetch('process-vehicle-scan.php', {
                method: 'POST',
                body: formData
            })
