        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <h1 class="text-xl font-semibold text-gray-900">Manage Departments</h1>
                        <p class="text-sm text-gray-500">Organize your departments</p>
                    </div>
                </div>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <form method="POST" class="space-y-6">
                        ...
                        <div class="flex justify-end space-x-4">
                            <a href="manage-departments.php" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">
                                Cancel
                            </a>
        ...
        <?php else: ?>
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="manage-departments.php?action=create" class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg font-medium transition-colors inline-flex items-center">
