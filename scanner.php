...
<body class="bg-gray-50">
    ...
    <script>
        ...
        // Auto-refresh if no activity (only on desktop to save mobile data)
        ...
        // Handle page visibility change (pause camera when tab is not active)
        ...
        video.addEventListener('touchend', function(e) {
            ...
            // Swipe up to start camera, swipe down to stop
            if (Math.abs(diff) > 50) {
                if (diff > 0 && !scanning) {
                    startCamera();
