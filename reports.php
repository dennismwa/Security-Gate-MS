...
<body class="bg-gray-50 pb-16 sm:pb-0">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-submit form on mobile when dates change
            if (window.innerWidth <= 768) {
                [dateFrom, dateTo, document.getElementById('report_type')].forEach(element => {
                    element.addEventListener('change', function() {
                        // Add a small delay to allow users to change multiple fields
        ...
        document.addEventListener('visibilitychange', function() {
            if (document.hidden) {
                // Pause any auto-refresh when tab is not active
        ...
        // Touch gesture for pull-to-refresh on mobile
        let startY = 0;
